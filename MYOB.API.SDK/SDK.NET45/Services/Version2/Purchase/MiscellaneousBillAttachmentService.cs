...
namespace MYOB.AccountRight.SDK.Services.Version2.Purchase
{
    ...
    /// </summary>
    public class MiscellaneousBillAttachmentService : MutableService<BillAttachmentWrapper>
    {
        /// <summary>
        ...
        public MiscellaneousBillAttachmentService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null)
        ...
        {
            get { return "/Purchase/Bill/Miscellaneous/{uid}/Attachment"; }
        }
        ...
        /// <exclude />
        // Examples:
        // baseUrl/Purchase/Bill/Miscellaneous/billUid/Attachment/attachmentUid
        ...
        public Uri BuildUri(CompanyFile companyFile, Guid billUid, Guid? attachmentUid = null, string queryString = null)
        {
            ...
            return new Uri(string.Format("{0}/{1}/{2}{3}{4}", companyFile.Uri, "Purchase/Bill/Miscellaneous", billUid.ToString(), "/Attachment", attchUid, qs));
        }
    }
}
