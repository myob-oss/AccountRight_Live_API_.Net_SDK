...
namespace MYOB.AccountRight.SDK.Services.Contact
{
    ...
    public sealed class EmployeePaymentSummaryReportService : ReadableService<EmployeePaymentSummaryReport>
    {
        ...
        public EmployeePaymentSummaryReportService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
