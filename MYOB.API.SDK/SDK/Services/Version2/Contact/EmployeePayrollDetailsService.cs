...
namespace MYOB.AccountRight.SDK.Services.Contact
{
    ...
    /// </summary>
    public sealed class EmployeePayrollDetailsService : MutableService<EmployeePayrollDetails>
    {
        /// <summary>
        ...
        public EmployeePayrollDetailsService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
        ...
        {
            get { return "Contact/EmployeePayrollDetails"; }
        }}
}
