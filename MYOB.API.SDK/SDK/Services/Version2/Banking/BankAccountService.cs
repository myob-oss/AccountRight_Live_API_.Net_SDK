...
namespace MYOB.AccountRight.SDK.Services.Banking
{
    ...
    public class BankAccountService : ReadableService<BankAccount>
    {
        ...
        public BankAccountService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory, IOAuthKeyService keyService, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
