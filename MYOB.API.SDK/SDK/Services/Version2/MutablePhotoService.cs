...
namespace MYOB.AccountRight.SDK.Services
{
    ...
    public abstract class MutablePhotoService<T> : MutableService<T>, IMutablePhoto<T> where T : BaseEntity
    {
        ...
        protected MutablePhotoService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory, IOAuthKeyService keyService, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
