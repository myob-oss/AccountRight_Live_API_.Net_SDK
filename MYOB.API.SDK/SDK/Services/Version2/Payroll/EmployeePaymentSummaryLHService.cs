...
{
    /// <summary>
    /// A service that provides access to the <see cref="EmployeePaymentSummaryLH"/> resource
    /// </summary>
    public sealed class EmployeePaymentSummaryLHService : PdfServiceBase<EmployeePaymentSummaryLH>
    {
        /// <summary>
        ...
        {
            get { return "Payroll/EmployeePaymentSummary/{0}/LH"; }
        }
    }
}