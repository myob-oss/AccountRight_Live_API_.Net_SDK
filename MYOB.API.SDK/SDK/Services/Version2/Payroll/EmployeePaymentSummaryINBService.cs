...
{
    /// <summary>
    /// A service that provides access to the <see cref="EmployeePaymentSummaryINB"/> resource
    /// </summary>
    public sealed class EmployeePaymentSummaryINBService : PdfServiceBase<EmployeePaymentSummaryINB>
    {
        /// <summary>
        ///  Initialise a service that can use <see cref="EmployeePaymentSummaryINB"/> resources
        /// </summary>
        /// <param name="configuration">The configuration required to communicate with the API service</param>
        /// <param name="webRequestFactory">A custom implementation of the <see cref="WebRequestFactory"/>, if one is not supplied a default <see cref="WebRequestFactory"/> will be used.</param>
        /// <param name="keyService">An implementation of a service that will store/persist the OAuth tokens required to communicate with the cloud based API at http://api.myob.com/accountright </param>
        public EmployeePaymentSummaryINBService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null)
        ...
        {
            get { return "Payroll/EmployeePaymentSummary/{0}/INB"; }
        }
    }
}