...
namespace MYOB.AccountRight.SDK.Services.Purchase
{
    ...
    public sealed class DebitSettlementService : MutableService<DebitSettlement>
    {
        ...
        public DebitSettlementService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
        ...
        {
            get { return "Purchase/DebitSettlement"; }
        }
    }
}