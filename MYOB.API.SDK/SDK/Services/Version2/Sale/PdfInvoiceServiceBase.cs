...
namespace MYOB.AccountRight.SDK.Services.Sale
{
    ...
    public abstract class PdfServiceBase<T> : MutableService<T>, IPdfService where T : BaseEntity
    {
        ...
        protected PdfServiceBase(IApiConfiguration configuration, IWebRequestFactory webRequestFactory, IOAuthKeyService keyService, IApiRequestHandlerFactory apiRequestHandlerFactory = null) 
