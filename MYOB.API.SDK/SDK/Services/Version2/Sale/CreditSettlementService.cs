...
namespace MYOB.AccountRight.SDK.Services.Sale
{
    ...
    public sealed class CreditSettlementService : MutableService<CreditSettlement>
    {
        ...
        public CreditSettlementService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
        ...
        {
            get { return "Sale/CreditSettlement"; }
        }
    }
}