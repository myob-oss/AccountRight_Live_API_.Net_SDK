...
namespace MYOB.AccountRight.SDK.Services.Sale
{
    ...
    public sealed class CalculateDiscountsFeesService : ServiceBase, IOperation<CalculateDiscountsFees, CalculateDiscountsFeesResponse>
    {
        ...
        public CalculateDiscountsFeesService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
