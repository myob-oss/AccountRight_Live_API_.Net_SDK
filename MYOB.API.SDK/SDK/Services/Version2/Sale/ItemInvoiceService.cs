...
namespace MYOB.AccountRight.SDK.Services.Sale
{
    ...
    public sealed class ItemInvoiceService : PdfServiceBase<ItemInvoice>
    {
        ...
        public ItemInvoiceService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
