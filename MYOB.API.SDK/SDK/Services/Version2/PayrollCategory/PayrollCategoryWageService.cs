...
namespace MYOB.AccountRight.SDK.Services.PayrollCategory
{
    ...
    /// </summary>
    public sealed class PayrollCategoryWageService : MutableService<PayrollCategoryWage>
    {
        /// <summary>
        ...
        public PayrollCategoryWageService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
