...
namespace MYOB.AccountRight.SDK.Services.PayrollCategory
{
    ...
    public sealed class PayrollCategoryDeductionService : ReadableService<PayrollCategoryDeduction>
    {
        ...
        public PayrollCategoryDeductionService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
