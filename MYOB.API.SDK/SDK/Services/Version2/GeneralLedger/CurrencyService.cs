...
namespace MYOB.AccountRight.SDK.Services.GeneralLedger
{
    ...
    public sealed class CurrencyService : ReadableService<Currency>
    {
        ...
        public CurrencyService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
