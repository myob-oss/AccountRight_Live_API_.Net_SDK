...
namespace MYOB.AccountRight.SDK.Services.GeneralLedger
{
    ...
    public sealed class ProfitLossDistributionService : GetOnlyService<ProfitLossDistribution>
    {
        ...
        public ProfitLossDistributionService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory = null, IOAuthKeyService keyService = null, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
