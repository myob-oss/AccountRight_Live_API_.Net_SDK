...
{
    /// <summary>
    /// A service that provides access to the <see cref="InventoryAdjustment"/> resource
    /// </summary>
    public sealed class InventoryAdjustmentService : MutablePhotoService<InventoryAdjustment>
    {
        /// <summary>
        ...
        {
            get { return "Inventory/Adjustment"; }
        }
    }
}