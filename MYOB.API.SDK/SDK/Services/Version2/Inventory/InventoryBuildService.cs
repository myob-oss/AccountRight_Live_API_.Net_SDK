...
namespace MYOB.AccountRight.SDK.Services.Inventory
{
    ...
    public sealed class InventoryBuildService : MutableService<InventoryBuild>
    {
        ...
        public InventoryBuildService(IApiConfiguration configuration, IWebRequestFactory webRequestFactory, IOAuthKeyService keyService, IApiRequestHandlerFactory apiRequestHandlerFactory = null)
