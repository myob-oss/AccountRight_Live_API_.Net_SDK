...
{
    /// <summary>
    /// Describe the Sale/Order/TimeBilling's Lines
    /// </summary>
    public class TimeBillingOrderLine : OrderLine
    {
        /// <summary>
        ...
        /// <summary>
        /// The hours spent doing the <see cref="TimeBillingOrderLine.Activity"/>
        /// </summary>
        ...
        /// <summary>
        /// The number of Units of the <see cref="TimeBillingOrderLine.Item"/>
        /// </summary>
