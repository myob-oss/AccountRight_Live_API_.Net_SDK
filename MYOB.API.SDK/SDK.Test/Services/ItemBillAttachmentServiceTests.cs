...
{
    [TestFixture]
    public class ItemBillAttachmentServiceTests
    {
        [Test]
        public void ServiceHasExpectedRoute()
        {
            Assert.AreEqual("/Purchase/Bill/Item/{uid}/Attachment", new ItemBillAttachmentService(null, null).Route);
        }

        [Test]
        public void When_NoAttachmentUIDProvided_ServiceBuildsURICorrectly()
        {
            var service = new ItemBillAttachmentService(null, null);
            var expected = new Uri("http://api.test.com/accountright/Purchase/Bill/Item/7c54adeb-ec94-493e-8317-f2c893ecadfc/Attachment");
        ...
        {
            var service = new ItemBillAttachmentService(null, null);
            var expected = new Uri("http://api.test.com/accountright/Purchase/Bill/Item/7c54adeb-ec94-493e-8317-f2c893ecadfc/Attachment/ae625ae8-96fd-4f5d-8c66-d6de2e2c96e3");
