...
IF "%appveyor_build_version%" == "" set appveyor_build_version = 1.0.0-rc1
.\.nuget\Nuget.exe pack MYOB.API.SDK\SDK.Package\Package.nuspec -Version %appveyor_build_version%
