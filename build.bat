...
.\packages\OpenCover.4.5.3723\OpenCover.Console.exe -register:user -filter:"+[MYOB.*]*" -skipautoprops -output:".\Artefacts\Coverage\output.xml" -target:".\packages\NUnit.Runners.2.6.4\tools\nunit-console.exe" -targetargs:".\Artefacts\SDK\Test\Release\SDK.Tests.dll /noshadow "
